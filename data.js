...
const siteDefaults = {
  ...
  aboutText: "نصنع تجربة تحريرية تربط التاريخ بالسياسة والتكنولوجيا بلغة صحفية أنيقة، وتصميم بصري يشعر القارئ بأنه داخل مجلة دولية حديثة.",
  newsletterTitle: "اشترك ليصلك أفضل ما ينشره رمسيس",
  newsletterText: "ملفات تحليلية مختارة، افتتاحيات قوية، ومقالات نوعية عن التاريخ والسياسة والتكنولوجيا.",
